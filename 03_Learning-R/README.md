...
RStudio is the user interface for working in R; it's effectively a software that makes it very easy to use R. It's analogous to how a web-browser gives you access to the internet. Just as there are many different types of web-browsers there are also other user interfaces to R. But RStudio is one of the most commonly used and full of a bunch of great functionalities.
